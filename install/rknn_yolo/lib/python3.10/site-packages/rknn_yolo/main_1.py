...
class CrossroadDetectorNode(Node):
    def __init__(self):
        ...
        self.CROSSROAD_COOLDOWN = 0.7  # 十字路口检测冷却时间（秒）
    ...
    def detect_crossroad(self, frame):
        ...
        # 上部区域检测
        roi_upper = frame[0:int(h*0.2), int(w * 0.3):int(w * 0.7), :]
    ...
    def image_callback(self, msg):
        ...
        is_crossroad = self.detect_crossroad(frame)
        ...
        # 发布病房方向信息
        if self.crossroad_id == self.last_crossroad_id and ward_directions:
